export default {
	...
	async postJson(apiUrl, data, fromPage = "/pages/index/index") {
		...
		//if(res.data.body!=null){
					// console.log(res.data.body.gender);
			if(res.data.body!=null&&res.data.body.gender==-1){
				uni.clearStorage();
				uni.reLaunch({
	...
	async uploadFile(tempFilePath) {
		...
		console.log(getApp().globalData.domain + "/oss/uploadImageOrVideo");
