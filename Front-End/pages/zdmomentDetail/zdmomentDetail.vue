...
<view class="moment-operation-comment moment-operation-item" @click.stop="toPublishMoment(moment.id)">
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			// 加载moment数据
			let [momentDetailData] = await httpUtils.postJson("/moment/getzdMomentDetail", {
