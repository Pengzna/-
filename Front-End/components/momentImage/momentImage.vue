<template>
	<view class="moment-image-container"><!--按图片个数不同，展示风格也不同 -->
		...
		<view class="moment-image-list" v-if="moment.imageList.length===1||moment.imageList.length===2 || moment.imageList.length===4">
